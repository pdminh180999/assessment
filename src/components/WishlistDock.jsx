...
export default function WishlistDock() {
    ...
    const handleDragEnd = async (event) => {
        ...
        // Swipe left
        if (over?.id === 'move-left-zone') {
            handleSwipeLeft();
        }
        // Swipe right
        if (over?.id === 'move-right-zone') {
            handleSwipeRight();
        }
        // Move to stack
                ...
                <div className="fixed bottom-0 right-0 left-0">
                    {currentSwipeCard && updatedCurrentStack && (
                        <div className="pointer-events-auto">
                            ...
                            <div
                                className="relative w-[226px] h-[360px] left-1/2 -translate-x-1/2 -translate-y-3/4 z-50">
                                <DroppableMoveZone isActive={dragState.isDragging} onMove={handleSwipeLeft}
                                                   isLeft={true}/>
                                ...
                                <DroppableMoveZone isActive={dragState.isDragging} onMove={handleSwipeRight}
                                                   isLeft={false}/>
                            </div>
                        </div>
                    )}
